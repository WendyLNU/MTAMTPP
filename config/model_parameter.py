...
class model_parameter:
    ...
    def __init__(self):
        ...
        self.flags.DEFINE_string('experiment_name', "mrzhao", "the expeiment")
    ...
    def get_parameter(self,type):
        ...
        if type == "hawkes_base_gru":
            self.flags.FLAGS.type = "hawkes"
            self.flags.FLAGS.causality = "unidirection"
