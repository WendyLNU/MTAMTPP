...
class base_model(object):
    ...
    def metrics_topK(self,sess,batch_data,global_step,topk):
        ...
        indices_result1,indices_result5, item_result = sess.run([indices1, indices5, item_result], input_dic)
        result_item = input_dic[self.embedding.target_item_id]
        length = len(batch_data)
        hr_1, ndcg_1,hr_list,ndcg_list = self.calculate_topK(1, indices_result1, result_item, global_step, length)
        hr_5, ndcg_5,_,_ = self.calculate_topK(5, indices_result5, result_item, global_step, length)
        #hr_10, ndcg_10,hr_list,ndcg_list_10= self.calculate_topK(10, indices_result10, result_item, global_step, length)
        ...
        return hr_1, ndcg_1, hr_5, ndcg_5,hr_list,ndcg_list
    ...
    def metrics_topK_concat(self,sess,batch_data,global_step,topk):
        ...
        hr_5, ndcg_5,_,_ = self.calculate_topK(5, indices_result5, result_item, global_step, length)
        hr_10, ndcg_10,hr_list_10,ndcg_list_10 = self.calculate_topK(10,indices_result10,result_item,global_step,length)
        hr_30, ndcg_30,_,_ = self.calculate_topK(30, indices_result30, result_item, global_step, length)
        hr_50, ndcg_50,_,_ = self.calculate_topK(50,indices_result50, result_item, global_step, length)
